...
- 🎮 **[`Game Library`](./Game_Library/)**: Web application built with Flask for managing a personal game collection. Features will include adding, editing, and deleting games, searching and filtering by genre, and storing data in a relational database. Designed with a responsive interface for easy browsing.
